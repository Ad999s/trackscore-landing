    ...
    <section className="py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className={cn(
            "grid md:grid-cols-2 gap-16 w-full transition-all duration-500",
            isVisible ? "animate-slideUp animation-delay-200" : "opacity-0"
          )}>
            {/* Order Cards */}
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-medium p-6 border border-gray-100">
                <div className="space-y-8">
                  ...
                  <div className="border-b pb-8">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-xl font-semibold">High Intent Order</h3>
                    </div>
                    ...
                    <div className="mt-3 inline-block px-3 py-1 bg-green-100 text-green-700 text-sm rounded-full">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center">
                        <span className="w-5 h-5 text-red-600 flex items-center justify-center font-bold">!</span>
                      </div>
                      <h3 className="text-xl font-semibold">Low Intent Order</h3>
                    </div>
                    ...
                    <div className="mt-3 inline-block px-3 py-1 bg-red-100 text-red-700 text-sm rounded-full">
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl font-bold mb-6">Smart Order Analysis</h3>
              <p className="text-gray-600 mb-6">Our AI analyzes over 30 data points from each incoming order, including:</p>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3">
                    <div className="w-6 h-6 mt-0.5 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">
