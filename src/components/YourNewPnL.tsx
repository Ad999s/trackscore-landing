        ...
        >
          <div className="mb-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              Your <span className="text-gradient">New P&L</span>
            </h2>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Save orders before they're shipped. Improve efficiency and maximize profits with our predictive analytics.
            </p>
          </div>
